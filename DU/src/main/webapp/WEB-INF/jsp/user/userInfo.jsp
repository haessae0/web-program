			...
			<div id="content">
				...
				<form action="userModify.do" method="post" id="userInfoForm">
					<div class="container-fluid">
						...
						<p class="mb-4">내 정보를 변경하기 위한 페이지 입니다.</p>
							...
							<div class="card-body">
								<div class="text-center">
									...
									<div class="form-group row">
										<div class="col-sm-6 mb-3 mb-sm-0">
											<input type="password" class="form-control form-control-user"
												name="pwd" id="pwdInput" placeholder="Enter the password">
										</div>
										<div class="col-sm-6">
											<input type="password" class="form-control form-control-user"
												id="pwdCheckInput" placeholder="reEnter the password">
										</div>
									</div>
									<div class="form-group row">
										<div class="col-sm-6 mb-3 mb-sm-0">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control form-control-user"
												name="job" value="${USER.job}" placeholder="Enter your job">
										</div>
									</div>
									<div class="form-group row">
										<div class="col-sm-6 mb-3 mb-sm-0">
									...
									<div class="form-group">
										<select name="areaCd" class="form-control" required>
											<c:forEach items="${area}" var="item">
												<option value="${item.areaCd}">
													<c:out value="${item.areaNm}" />
												</option>
											</c:forEach>
										</select>
									</div>
									<a href="#" class="btn btn-success btn-icon-split" id="okBtn">
									...
									<div>
										...
										</span> <span class="text">회원탈퇴</span>
										</a>
									</div>
								</div>
							</div>
